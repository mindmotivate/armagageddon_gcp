...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Attack of the Keishas!!!</title>
    <!-- CSS Reset -->
    <link
      rel="stylesheet"
            ...
            if (!bullets[i].destroyed) {
              ...
              for (var j = 0; j < asteroids.length; j++) {
                if (!asteroids[j].destroyed) {
                  ...
                  if (
                    distance <
                    asteroids[j].width / asteroids[j].size / 2 -
                      4 +
                      (19 / 2 - 4)
                  ) {
                    destroyed += 1;
        ...
        function start() {
          if (!gameOver) {
            ...
            if (playing) {
              ...
              // ctx.fillText(
              //   "InterGalactic PassportBros are under attack by Planet Keisha!!!",
              //   20,
              //   30
              // );
              ctx.fillText(
                "InterGalactic PassportBros are under attack by Keisha Planets!!!",
                20,
                30
              );
              ctx.fillStyle = "white";
              ctx.fillText("High Score: " + record + "", 20, 60);
              ...
              // ctx.textBaseline = "middle";
              // ctx.textAlign = "left";
              // ctx.fillText("Attack of the Keisha Planets!!!", 20, 30);
              // // End-------------------
              // Sample Code 2-------------
              ...
              ctx.textAlign = "center";
              ctx.fillText(
                "Attack of the Keisha Planets!!!",
                cW / 2,
                cH / 2 - 250
              );
              // End-------------------

              // // Sample Code Glow Blur Effect-------------
            ...
            ctx.fillText("HOLD THE LINE!.. FIGHT ON!!!", cW / 2, cH / 2 - 150);

            ctx.font = "30px Luckiest Guy";
            ctx.fillStyle = "white";
            ctx.textAlign = "center";
            ctx.fillText(
              "Kiesha Asteroids Sent to the Upper Room: " + destroyed,
              cW / 2,
              cH / 2 + 140
            );
